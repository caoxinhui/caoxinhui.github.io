...
export default function BottomNavigation({
    ...
    const {
        iPhoneX,
        isSSR
    } = state; // 是否 iPhoneX 设备已经存储在 state 里, 兼容服务端 & 客户端, 不需要再重新判断
    ...
    return ( <
        div className = {
            cx("nav_bottom_wrapper expose_dom", {
...
function BottomNav({
    ...
    return ( <
            div data - trace - key = "tang_page_button_click"
            data - trace - value = {
                JSON.stringify({
                    ...traceValue,
                    button: "bottomtab",
            ...
            } >
            {
                !hideText && < p id = {
                    ...
                    />} {
                        showImg && < ImageHelper imgUniqueId = {
                            imgUniqueId
                        }
                        textUniqueId = {
                            textUniqueId
